var heartMess = document.getElementsByClassName("fa-heart");
var thumbMess = document.getElementsByClassName("fa-thumbs-up");

Array.from(heartMess).forEach(function(element) {
